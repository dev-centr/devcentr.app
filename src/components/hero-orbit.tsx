...
export function HeroOrbit(props: { class?: string }) {
  return (
    <div class={`pointer-events-none absolute inset-0 overflow-hidden ${props.class ?? ""}`} aria-hidden="true">
      <svg
        class="absolute -right-[18%] top-[-12%] h-[120%] w-auto max-w-none text-primary opacity-[0.22] md:-right-[8%] md:top-[-8%] md:opacity-[0.28]"
        viewBox="0 0 800 800"
      ...
      >
        ...
        <circle cx="400" cy="400" r="160" fill="none" stroke="currentColor" stroke-width="1" opacity="0.45" />
